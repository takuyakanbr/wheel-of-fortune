      ...
      <table class="options-table">
        <tr>
          ...
          <td class="options-input-cell">
            <input type="text" id="tb-wheel-name" v-model="options.name" placeholder="Wheel of Fortune" />
          </td>
        </tr>
        <tr>
          <td><label for="tb-winning-text">Winning Text</label></td>
          <td class="options-input-cell">
            <input type="text" id="tb-winning-text" v-model="options.winningText" placeholder="Result: <b>%s</b>" />
          </td>
        </tr>
        <tr>
          <td><label for="tb-background-image">Background Image</label></td>
          <td class="options-input-cell">
            <input type="text" id="tb-background-image" v-model="options.background" placeholder="none" />
          </td>
        </tr>
        <tr>
